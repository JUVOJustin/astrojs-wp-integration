...
When `resource` is omitted it defaults to `'posts'`. See [Post actions — Pages and custom post types](./posts.mdx#pages-and-custom-post-types) for that pattern, or [Ability actions](./abilities.mdx) for the WordPress Abilities API.
