...
- The package is aligned to `fluent-wp-client` `^3.0.1`; loader payloads for post/page resources must remain plain serializable objects (no legacy helper methods on `entry.data`).
